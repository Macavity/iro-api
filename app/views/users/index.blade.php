        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">API Admins</h3>
                </div>
                ...
                <table class="table table-hover" id="dev-table">
                    ...
                    <tr>
                        ...
                        <td>{{ $user->serial }}</td>
                        <td>
                            <a class="btn btn-small btn-success" href="{{ action('UsersController@show', $user->id) }}">Details</a>
                            <a class="btn btn-small btn-info" href="{{ action('UsersController@edit', $user->id) }}">Bearbeiten</a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
